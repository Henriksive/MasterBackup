...
%Despite the current interest in smart cards to enable the development of secure commercial mobile devices \cite{tiger, secursmart}, the amount of publicly accessible research on the topic are quite low.  because of this, we are not aware of academic research looking into the challenges of securing modern smartphones with smart cards as secure elements.
